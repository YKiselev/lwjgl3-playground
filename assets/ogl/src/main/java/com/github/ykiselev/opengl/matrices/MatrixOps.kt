...
abstract class MatrixOps : Vector4fOps() {

    abstract fun matrix(): Matrix

    inline fun matrix(init: (Matrix, Int) -> Unit): Matrix {
        val result = matrix()
        (0..15).forEach {
            init(result, it)
        }
    ...
    fun matrix(src: FloatArray): Matrix {
        val result = matrix()
        (0..15).forEach {
            result[it] = src[it]
        }
    ...
    companion object {
        ...
        fun perspective(left: Float, right: Float, top: Float, bottom: Float, near: Float, far: Float, m: FloatBuffer) {
            m.put(0, (2.0 * near / (right - left)).toFloat())
                .put(1, 0f)
                .put(2, 0f)
                .put(3, 0f)
                .put(4, 0f)
                .put(5, (2.0 * near / (top - bottom)).toFloat())
                .put(6, 0f)
                .put(7, 0f)
                .put(8, (right + left) / (right - left))
                .put(9, (top + bottom) / (top - bottom))
                .put(10, -(far + near) / (far - near))
                .put(11, -1f)
                .put(12, 0f)
                .put(13, 0f)
                .put(14, (-2.0 * far * near / (far - near)).toFloat())
                .put(15, 0f)
        }
        ...
        fun add(a: FloatBuffer, b: FloatBuffer, result: FloatBuffer) {
            ...
            result.put(0, m0).put(1, m1).put(2, m2).put(3, m3)
                .put(4, m4).put(5, m5).put(6, m6).put(7, m7)
                .put(8, m8).put(9, m9).put(10, m10).put(11, m11)
                .put(12, m12).put(13, m13).put(14, m14).put(15, m15)
        }
         ...
         * @param r the result
         */
        fun multiply(a: FloatBuffer, v: Vector3f, r: Vector3f) {
            r.set(
         ...
         * @param r the result
         */
        fun multiply(a: FloatBuffer, v: Vector4f, r: Vector4f) {
            r.set(
        ...
        fun rotation(ax: Double, ay: Double, az: Double, result: FloatBuffer) {
            ...
            val e = cos(az)
            val f = sin(az)
            result.put(0, (c * e).toFloat())
                .put(1, (b * d * e + a * f).toFloat())
                .put(2, (-a * d * e + b * f).toFloat())
                .put(3, 0f)
                .put(4, (-c * f).toFloat())
                .put(5, (-b * d * f + a * e).toFloat())
                .put(6, (a * d * f + b * e).toFloat())
                .put(7, 0f)
                .put(8, d.toFloat())
                .put(9, (-b * c).toFloat())
                .put(10, (a * c).toFloat())
        ...
        fun inverse(a: FloatBuffer, result: FloatBuffer) {
            ...
            result.put(0, A.toFloat()).put(1, -E.toFloat()).put(2, I.toFloat()).put(3, -M.toFloat())
                .put(4, -B.toFloat()).put(5, F.toFloat()).put(6, -J.toFloat()).put(7, N.toFloat())
                .put(8, C.toFloat()).put(9, -G.toFloat()).put(10, K.toFloat()).put(11, -O.toFloat())
                .put(12, -D.toFloat()).put(13, H.toFloat()).put(14, -L.toFloat()).put(15, P.toFloat())
