 ...
 * Note: single-line or multi-line comments inside quoted text will be treated as a part of that text.
 * <p/>
...
interface Tokenizer {
     ...
     * @return the index of the last scanned character in `text`.
     */
    fun tokenize(text: String?, fromIndex: Int, result: MutableCollection<String>): Int
}
